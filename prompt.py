...
Now, please try to do the following task for me:
    # 4. Try to give the mood of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 5. Try to give the genre of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 6. Try to give the theme of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 7. Try to give the message of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 8. Try to give the story of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 9. Try to give the meaning of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    # 10. Try to give the complete review of the song "Charlie Be Quiet!" by Charlie Puth whose lyrics are given above.
    ...
    4. Try to give the complete mood of the song {song_name} by {artist} whose lyrics are given above.
    5. Try to give the complete genre of the song {song_name} by {artist} whose lyrics are given above.
    6. Try to give the complete theme of the song {song_name} by {artist} whose lyrics are given above.
    7. Try to give the complete message of the song {song_name} by {artist} whose lyrics are given above.
    8. Try to give the complete story of the song {song_name} by {artist} whose lyrics are given above.
    9. Try to give the complete meaning of the song {song_name} by {artist} whose lyrics are given above.
